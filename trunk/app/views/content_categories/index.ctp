<div class="contentCategories index">
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $contentCategory['ContentCategory']['id']; ?>&nbsp;</td>
		<td>
		...
		<td><?php echo $contentCategory['ContentCategory']['lft']; ?>&nbsp;</td>
		<td><?php echo $contentCategory['ContentCategory']['rght']; ?>&nbsp;</td>
		<td><?php echo $contentCategory['ContentCategory']['active']; ?>&nbsp;</td>
		<td><?php echo $contentCategory['ContentCategory']['name']; ?>&nbsp;</td>
		<td><?php echo $contentCategory['ContentCategory']['description']; ?>&nbsp;</td>
		<td><?php echo $contentCategory['ContentCategory']['created']; ?>&nbsp;</td>
		<td><?php echo $contentCategory['ContentCategory']['modified']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $contentCategory['ContentCategory']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $contentCategory['ContentCategory']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $contentCategory['ContentCategory']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $contentCategory['ContentCategory']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
